...
public class ParserData {
	...
	public int parserSpeed(byte data[]){
		...
		if(yadiSpeedHallCount == 0){
			speedKm = 3.18f*1.2f*(speedHallCount*circumference/1000f)/(6f*MyApplication.app.deviceNotes.optMotorJds(false, 1));
		}else{
			speedKm = 3.18f*1.2f*(yadiSpeedHallCount*circumference/1000f)/6f/MyApplication.app.deviceNotes.optMotorJds(false, 1);
		}
